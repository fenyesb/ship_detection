...
weights_path = 'ShipDetection_trasfered_from_VGG_coco_SSD_300x300_iter_400000.h5'
...
model_checkpoint = ModelCheckpoint(filepath='mycrop-ShipDetection-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
csv_logger = CSVLogger(filename='mycrop_training_log.csv',
                       separator=',',
                       append=True)
